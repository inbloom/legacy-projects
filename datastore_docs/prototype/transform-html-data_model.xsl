...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:template name="user.header.navigation">
        ...
        <div id="menu-left">
            ...
            <ul>
                <li>
                    <a href="../data_model/domains.html" target="_top">Domains</a>
                </li>
                <li>
                    <a href="../data_model/entities.html" target="_top">Entities</a>
                </li>
                <li>
                    <a href="../data_model/attributes.html" target="_top">Attributes</a>
                </li>
                <li>
                    <a href="../data_model/types.html" target="_top">Types</a>
                </li>
            </ul>
        </div>
    </xsl:template>
