...
<xsl:template match="d:itemizedlist">
  <!-- CUSTOMIZATION POINT: Commented out variables used to create class and type -->
  ...
  <div>
    ...
    <ul>
      <!-- CUSTOMIZATION POINT: Commented out calls that create the class and type for <ul> elements -->
...
<xsl:template match="d:itemizedlist/d:listitem">
  ...
  <li>
    <xsl:call-template name="common.html.attributes"/>
    <xsl:call-template name="id.attribute"/>
    <!-- CUSTOMIZATION POINT: Commented out settings that can create inline CSS -->
...
<xsl:template match="d:variablelist">
  ...
  <!-- CUSTOMIZATION POINT: Commented out creating an HTML class attribute for a variablelist element -->
  <!-- <xsl:variable name="default.class">
    <xsl:value-of select="local-name()"/>
    <xsl:if test="@spacing = 'compact'">
      <xsl:text> compact</xsl:text>
  ...
  <div>
    ...
    <xsl:choose>
      <xsl:when test="$presentation = 'table'">
        ...
        <table border="{$table.border.off}">
          <!-- CUSTOMIZATION POINT: Commented out calls that create the class for an HTML table element -->
          <!-- <xsl:call-template name="generate.class.attribute">
            <xsl:with-param name="class" select="$default.class"/>
          </xsl:call-template> -->
      ...
      <xsl:otherwise>
        ...
        <xsl:apply-templates 
          select="*[not(self::d:varlistentry
                  ...
                  |processing-instruction()[not(preceding-sibling::d:varlistentry)]"/>
        <dl>
          <!-- CUSTOMIZATION POINT: Commented out calls that create the class and type for <dl> elements -->
          <!-- <xsl:call-template name="generate.class.attribute">
            <xsl:with-param name="class" select="$default.class"/>
          </xsl:call-template> -->
          <xsl:apply-templates 
  ...
  <div>
    ...
    <xsl:choose>
      <xsl:when test="count(d:step) = 1">
        <ul>
          <!-- CUSTOMIZATION POINT: Commented out creating class attribute for <ul> elements in procedures -->
          <!-- <xsl:call-template name="generate.class.attribute"/> -->
          <xsl:apply-templates 
            select="d:step
      ...
      <xsl:otherwise>
        <ol>
          <!-- CUSTOMIZATION POINT: Commented out creating class attribute for <ol> elements in procedures -->
          <!-- <xsl:call-template name="generate.class.attribute"/> -->
          <xsl:attribute name="type">
...
<xsl:template match="d:calloutlist">
  <div>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <dl>
          <!-- CUSTOMIZATION POINT: Commented out creating class attribute for <dl> elements in callouts -->
