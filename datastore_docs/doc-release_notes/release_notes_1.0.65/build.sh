...
RELEASE=1.0.65
TARGETDIR=1.0.65_Release_Notes
...
#echo "Converting rally_op_stories.xml...";
#xsltproc --xinclude -o rally_op_stories.xml ../rally_stories_to_docbook.xsl #rally_op_stories-raw.xml
